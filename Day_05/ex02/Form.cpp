...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/04/21 18:08:25 by okushnir          #+#    #+#             */
/*   Updated: 2022/04/21 18:08:26 by okushnir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
const char * Form::SignedBeforeException::what(void) const throw()
{
	return ("Form::SignedBeforeException");
}

const char * Form::NotSignedYetException::what(void) const throw()
{
	return ("Form::NotSignedYetException");
}
